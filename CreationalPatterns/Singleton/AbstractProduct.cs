...
namespace CreationalPatterns.Singleton
{
    ...
    internal abstract class AbstractProduct
    {
        ...
        public DateTime ProductCreationDateTime
        {
            get;
            set;
        }
        ...
        {
            return $"Product Name - {ProductName}, Monitor Size - {MonitorSize}, Number Of Keys -{NumberOfKeys}, Creation Time -{ProductCreationDateTime}";
        }
    }
}
namespace Algorithms.TreeDataStructure.BTree
{
    public class BTreeNumberTEST
    {
        ...
        {
            BTreeNumber x = new BTreeNumber(3);
            ...
            List<int> inputList = new List<int>() { 23, 41, 190, 152, 39, 44, 43, 134, 181, 12, 175, 149, 189, 123, 144, 143, 126, 234, 111, 15, 1, 26, 256, 13, 271, 167, 222, 56, 30, 6, 345, 115, 10 };
